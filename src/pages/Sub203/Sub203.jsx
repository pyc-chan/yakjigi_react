    ...
    return (
        <>
            <div className={styles.titles}>
                <h2 className={styles.maintitle}>병용금기 검색하기</h2>
                <p className={styles.subtitle}>병용 금기약품을 찾아보세요</p>
            </div>
            ...
            <div className={styles.content_container}>
                <div className={styles.medi_result01}>
                    ...
                    <div className={styles.medi_infos}>
                        ...
                        <div className={styles.medi_div}>
                            <span className={styles.medi_title}>약품이름어쩌고정</span><br/>
                            <br />
                            <span className={styles.medi_info}>약품 정보1</span>
                            <span className={styles.medi_detail}>약품 정보 어쩌고저쩌고 어쩌고저쩌고 어쩌고저쩌고 어쩌고저쩌고 어쩌고저쩌고 어쩌고저쩌고 어쩌고저쩌고 어쩌고저쩌고 어쩌고저쩌고 어쩌고저쩌고 입니다.</span><br/>
